...
<pre>
1) Download an installation ISO from Microsoft and the XML files from this repo.
2) Mount the ISO, by double-clicking the file you got from Microsoft.
3) Copy/paste the contents of the mounted drive into a newly created folder on your desktop, name does not matter.
4) Open NTLite.
...
11) Add the latest Cumulative Update, .NET framework, security updates, ect. then click Enqueue.
